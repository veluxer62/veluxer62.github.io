...
당근마켓이 일하는 방식을 보고 정말 함께 일해보고 싶다라는 생각을 가지게 되었습니다. 저는 목록을 나열할때 가장 중요하게 생각하는 부분이 1번이라고 생각합니다. 왜냐하면 제 아내가 맛집리스트를 주고 어디를 갈지 고르라하면 1번을 고르면 됬었거든요 ^^. 당근마켓이 일하는 방식 중 1번은 "스스로 업무를 선택해요"라는 말이었습니다. 그만큼 업무에 대한 적극성을 중요시하고 자율성이 높다는 말로 이해를 하였습니다. 저는 일을 할때 자발성이 중요하다고 생각합니다. 그래야 내가 더 일을 잘할 수 있고 좀더 나아지기 위해 노력하니까요. 그래서 저는 제가 가진 잠재력을 이곳에서 적극적으로 발휘하고 싶다는 생각을 하였고 그래서 지원하게 되었습니다.

## 이직사유

문득 제가 언제부터 수동적으로 일하고 있다라는 생각을 가지게 되었어요. 처음 입사하였을 때 회사의 모습과 많이 바뀐것을 느꼈었습니다. 이런 분위기를 바꾸기 위해 대표님과 면담도 해보고 무엇이 문제인지 동료들과 함께 얘기를 해보려고 노력을 많이 했었습니다. 나름대로 자극을 주기위해 혼자 공부를 열심히 하고 새로운 환경으로 서비스를 개발해보기도 하였지만 쉽사리 변하지 않았습니다. 저는 제가할 수 있는 노력을 다했고 그래도 이러한 상황이 나아지지 않아 이직을 결심하게 되었습니다.
