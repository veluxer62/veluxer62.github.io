...
피할 수 없으면 즐기라고 했던가. 우리가 애플리케이션을 개발하면서 적어도 내가 살아있는 동안은 Nullable 타입은 계속해서 존재할 것으로 생각한다. 솔직히 Java는 힘들 수 있겠지만 Kotlin을 사용한다면 Nullable 타입을 좀 더 적극적으로 수용하여 좀 더 우아하고(?) 효율적으로 처리하는 노력을 기울여보는 것은 어떨까.
